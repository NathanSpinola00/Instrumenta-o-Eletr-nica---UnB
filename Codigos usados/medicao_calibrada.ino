...
// ============================================================ REALIZANDO AS MEDIÇÕES MÉDIAS ============================================================
  ...
  angulo = (atan( (saida_y / (sqrt ((square (saida_x)) + (square (saida_z)))) )))*180/M_PI;
  Serial.println("Angulo Acelerômetro: " + String(angulo));
  ...
  Serial.println("=====================================");
  //Serial.println("Angulo Acelerômetro: " + String(angulo));
  //Serial.println("saida real X : " + String(saida_x));
  //Serial.println("saida real Y : " + String(saida_y));
  //Serial.println("saida real Z : " + String(saida_z));
